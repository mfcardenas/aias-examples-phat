...
When resizing the house, the size of the GRID must be taken into account to represent the size of the house. That is, the house must have a size proportional to the GRID.
...
<p align="center">
<img src="https://github.com/mfcardenas/aias-examples-phat/blob/master/assets/img/jme3/img_structure_node_iv.png" width="40%" heigth="40%" alt="Structure Node" style="border: 1"/>
</p>
